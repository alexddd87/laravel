            ...
            <div class="panel-body">
                <div class="form">
                    {!! Form::open(['class' => 'cmxform form-horizontal tasi-form save_or_create_form', 'novalidate'=>"novalidate"]) !!}
                        ...
                        <div class="form-group ">
                            <label for="slug" class="control-label col-lg-2">Keywords</label>
                            <div class="col-lg-10">
                                <input class="form-control" id="slug" name="url" type="text" value="{{ isset($item->url) ? $item->url : '' }}" required>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="slug" class="control-label col-lg-2">Description</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                @endif
                                {!! link_to_route($moduleName . '.index', 'Отмена', [], ['class' => 'btn btn-default']) !!}
                            </div>
                        </div>
