    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="buttonPanel">
                <a href="/admin/{{ $moduleName }}/create" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> <span>Добавить новую страницу</span></a>
            </div>
                    ...
                    @foreach($list as $row)
                        ...
                        <tr id="sort{{ $row->id }}">
                            ...
                            <td width="10%">
                                ...
                                {{ Form::open(['url' => 'admin/'.$moduleName.'/' . $row->id, 'class' => 'inline']) }}
