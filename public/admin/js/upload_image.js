...
$(document).ready(function(){
	...
	$("#image_file_extra").live('change', function(){
		...
		aFormData.append("image", $(this).get(0).files[0]);
		aFormData.append("action", action);
		aFormData.append("path", path_image);
		aFormData.append("image_id", image_id);
		aFormData.append("width", width_image);
		aFormData.append("height", height_image);
		aFormData.append("width2", width2);
		aFormData.append("height2", height2);
		aFormData.append("type_upload", type_upload);

		$.ajax({type:"POST",url:"/admin/ajax/includephoto", data:aFormData, dataType:'json',processData: false,contentType: false,cache:false,success:
			function(data)
			{
	...
	$("#image_file").live('change',function(){
		...
		aFormData.append("action", action);
		aFormData.append("path", path_image);
		aFormData.append("image_id", $("#resize_photo_id").val());
		aFormData.append("width", width_image);
		aFormData.append("height", height_image);
		aFormData.append("width2", width2);
		aFormData.append("height2", height2);
